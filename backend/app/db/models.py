...
class Customer(Base):
    ...
    contract_number: Mapped[str] = mapped_column(String(32), unique=True, index=True, default="")
    meter_id: Mapped[str] = mapped_column(String(32), index=True, default="")
    meter_type: Mapped[str] = mapped_column(String(32), default="Single-phase")
    connection_type: Mapped[str] = mapped_column(String(32), default="Residential")
    transformer_id: Mapped[str] = mapped_column(String(32), index=True, default="")
...
class CustomerRiskSummary(Base):
    ...
    loss_label: Mapped[str] = mapped_column(String(64), default="")
    reasons_json: Mapped[str] = mapped_column(Text, default="[]")
    comparisons_json: Mapped[str] = mapped_column(Text, default="{}")
    triggers_json: Mapped[str] = mapped_column(Text, default="[]")
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
